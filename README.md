...
* [Scrapy](https://github.com/scrapy/scrapy) ⭐ 64,431 | 🐛 369 | 🌐 Python | 📅 2026-09-21 - A fast high-level screen scraping and web crawling framework.
...
* [StormCrawler](http://github.com/DigitalPebble/storm-crawler/) ⭐ 996 | 🐛 30 | 🌐 Java | 📅 2026-09-21 - An open source collection of resources for building low-latency, scalable web crawlers on Apache Storm
...
* [crawlee](https://github.com/apify/crawlee) ⭐ 25,860 | 🐛 152 | 🌐 TypeScript | 📅 2026-09-21 - A web scraping and browser automation library for Node.js that helps you build reliable crawlers. Fast.
...
* [httrack](https://github.com/xroche/httrack) ⭐ 4,761 | 🐛 2 | 🌐 C | 📅 2026-09-20 - Copy websites to your computer.
...
* [spider](https://github.com/spider-rs/spider) ⭐ 2,727 | 🐛 1 | 🌐 Rust | 📅 2026-09-16 - The fastest web crawler and indexer.
