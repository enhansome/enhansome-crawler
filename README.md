...
* [Scrapy](https://github.com/scrapy/scrapy) ⭐ 64,441 | 🐛 346 | 🌐 Python | 📅 2026-09-22 - A fast high-level screen scraping and web crawling framework.
...
* [PSpider](https://github.com/xianhu/PSpider) ⭐ 1,832 | 🐛 3 | 🌐 Python | 📅 2022-06-10 - A simple spider frame in Python3.
...
* [Webmagic](https://github.com/code4craft/webmagic) ⭐ 11,674 | 🐛 367 | 🌐 Java | 📅 2025-12-20 - A scalable crawler framework.
...
* [Heritrix3](https://github.com/internetarchive/heritrix3) ⭐ 3,321 | 🐛 36 | 🌐 Java | 📅 2026-09-22 -  Extensible, web-scale, archival-quality web crawler project.
...
* [StormCrawler](http://github.com/DigitalPebble/storm-crawler/) ⭐ 996 | 🐛 25 | 🌐 Java | 📅 2026-09-22 - An open source collection of resources for building low-latency, scalable web crawlers on Apache Storm
...
* [Hawk](https://github.com/ferventdesert/Hawk) ⭐ 3,210 | 🐛 67 | 🌐 C# | 📅 2019-12-21 - Advanced Crawler and ETL tool written in C#/WPF.
...
* [crawlee](https://github.com/apify/crawlee) ⭐ 25,865 | 🐛 150 | 🌐 TypeScript | 📅 2026-09-22 - A web scraping and browser automation library for Node.js that helps you build reliable crawlers. Fast.
...
* [scraperjs](https://github.com/ruipgil/scraperjs) ⭐ 3,713 | 🐛 27 | 🌐 JavaScript | 📅 2020-10-18 - A complete and versatile web scraper.
...
* [httrack](https://github.com/xroche/httrack) ⭐ 4,762 | 🐛 7 | 🌐 C | 📅 2026-09-22 - Copy websites to your computer.

## Ruby

* [Nokogiri](https://github.com/sparklemotion/nokogiri) ⭐ 6,280 | 🐛 127 | 🌐 C | 📅 2026-09-21 - A Rubygem providing HTML, XML, SAX, and Reader parsers with XPath and CSS selector support.
...
* [spider](https://github.com/spider-rs/spider) ⭐ 2,729 | 🐛 1 | 🌐 Rust | 📅 2026-09-16 - The fastest web crawler and indexer.
